...
class Header {
  constructor() {
    ...
    this.dropdownLogoutButton = document.getElementById(
  ...
  _updateAuthUI() {
    ...
    const userDropdownContainer = document.querySelector(
    ...
    if (navList) {
      navList
        .querySelectorAll('.auth-nav-item')
        .forEach((item) => item.remove());
    }
    const existingAuthButtons = document.querySelector(
    ...
    if (isLoggedIn()) {
      ...
      registerLink.innerHTML =
        '<i class="fa-solid fa-user-plus" aria-hidden="true"></i> <span>Daftar</span>';
